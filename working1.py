    ...
    async def get_reply(self, user_text: str) -> str:
        ...
        try:
            resp = await openai_client.chat.completions.create(
                ...
                max_tokens=40,  # Shorter responses = faster
                temperature=0.8,
...
async def text_to_speech_stream(session: CallSession, text: str, ws: WebSocket, stream_sid: str):
    ...
    try:
        # 1. Fetch Audio from Deepgram with Luna voice - faster timeout
        ...
        # 2. Stream to Twilio with larger chunks for smoother playback
        # Use 640 bytes (80ms chunks) - larger chunks = smoother audio
        chunk_size = 640
